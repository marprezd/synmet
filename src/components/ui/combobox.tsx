...
function ComboboxTrigger({
  ...
  return (
    ...
    >
      {children}
      <IconChevronDown className="size-4 text-muted-foreground pointer-events-none" />
    </ComboboxPrimitive.Trigger>
  )
}
